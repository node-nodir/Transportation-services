  ...
  return (
    ...
    >
      <label className="relative text-15 flex flex-col text-white">
        ...
        {
          render ? (
            <div className='w-full h-[200px] overflow-y-scroll rounded absolute bg-white z-50 top-[73px]'>
              {
                data?.map((item: Item) => (
                  <p onClick={() => {
                    setFromValue(item);
      ...
      <div className='grid grid-cols-2 gap-4 mt-1'>
        <div className="flex items-center pl-4 rounded-xl border-2 h-45 border-white bg-white cursor-pointer">
          <input id="bordered-radio-1" type="radio" name="bordered-radio" className="w-7 h-7 border border-[#D3D3D3] accent-amber-600 cursor-pointer" />
          <label htmlFor="bordered-radio-1" className="py-4 ml-2 w-full text-base font-medium text-gray-900 cursor-pointer">Open</label>
        </div>
        <div className="flex items-center pl-4 rounded-xl border-2 h-45 border-white bg-white cursor-pointer">
          <input id="bordered-radio-2" type="radio" name="bordered-radio" className="w-7 h-7 border border-[#D3D3D3] accent-amber-600 cursor-pointer" />
